...
⚠️ 第二重要：必须针对整篇论文的主题评审，先明确论文的研究主题是什么，然后所有评审意见都围绕这个主题。不要被论文中的部分段落、引用文献或背景介绍带偏，去评审另一个不相关的主题。
- 如果论文是关于粒子群优化算法的，就评审粒子群优化算法的方法、实验、结果，不要去评审强化学习或自动驾驶
- 如果论文是关于多智能体强化学习的，就评审多智能体强化学习的方法、实验、结果，不要去评审其他不相关的主题
"""
...
{{
  ...
  "margin": x.x,
  "comment": "300-400字的综合审稿意见，必须用中文输出！包括：(1)论文的主要优点和贡献；(2)论文的主要缺陷和问题；(3)建议作者重点修改的方向；(4)最终给出'建议接受/小修/大修/拒稿'的综合结论。特别指出两位审稿人是否有立场动摇的情况。"
}}
